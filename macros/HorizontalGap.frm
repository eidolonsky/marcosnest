VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} horizontalAlign 
   Caption         =   "Horizontal Align"
   ClientHeight    =   2295
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   2145
   OleObjectBlob   =   "HorizontalGap.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "horizontalAlign"
